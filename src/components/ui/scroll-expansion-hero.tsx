...
const ScrollExpandMedia = ({
  ...
  return (
    <div
      ref={sectionRef}
      className='transition-colors duration-700 ease-in-out overflow-x-hidden max-w-[100vw]'
    >
      <section className='relative flex flex-col items-center justify-start min-h-[100dvh] overflow-hidden'>
        <div className='relative w-full flex flex-col items-center min-h-[100dvh]'>
          ...
          <div className='w-full flex flex-col items-center justify-start relative z-10'>
            ...
            <motion.section
              className='flex flex-col w-full px-4 sm:px-8 py-10 md:px-16 lg:py-20 overflow-x-hidden'
              initial={{ opacity: 0 }}
