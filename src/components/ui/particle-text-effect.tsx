...
const DEFAULT_WORDS = ["RAUTENBERG", "ALTO PADRÃO", "ABC PAULISTA", "BROKER"]

export function ParticleTextEffect({ words = DEFAULT_WORDS, className, transparent = false }: ParticleTextEffectProps) {
